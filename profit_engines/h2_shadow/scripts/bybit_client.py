...
def _default_base() -> str:
    """2026-08-27: Demo switch — private (signed) calls route to api-demo
    when BYBIT_DEMO=true in ENV_PATH. Market data stays mainnet-priced;
    demo environment mirrors mainnet prices (verified 2026-08-27)."""
    import os as _os
